                ...
                if(data.error){
                    ...
                    shuffledArray.forEach(index => {
                        ...
                        if (videos[index].id.kind!="youtube#video"){
                            ...
                            interestingStuffContainer.innerHTML+= '<div class="fakeimg" > <a href='+videoUrl+' target="_blank" rel="noopener noreferrer"> <img class= "youtube-thumbnail" src='+videoThumbnail+' ><br></a>' +videoTitle+ '</div><br>'
                            count+=1
